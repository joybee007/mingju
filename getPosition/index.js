...
window.onload=function(){
	...
	if(navigator.geolocation){
		...
		var lanDiv=document.getElementById('lan');
		...
		var logDiv=document.getElementById('log');
		 ...
		 function getSuccess(position){
			...
			latDiv.innerHTML=position.coords.latitude;
			lanDiv.innerHTML=position.coords.longitude;
			accDiv.innerHTML=position.coords.accuracy;
			logDiv.innerHTML='OK';
			  // 估算的纬度
		 ...
		 function getError(error){
			  ...
			  switch(error.code){
				   ...
				   case error.PERMISSION_DENIED:
						logDiv.innerHTML=('用户拒绝提供地理位置');
						break;
				   case error.POSITION_UNAVAILABLE:
						logDiv.innerHTML=('地理位置不可用');
						break;
				   default:
						break;
			  }
